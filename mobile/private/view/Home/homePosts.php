                    ...
                    <div class="eachpostholder">
                        ...
                        <div class="eachpostinside">
                            ...
                            <div class="postleftholderright">
                                ...
                                <a href="index.php?page=home&action=getOnePost&postId=<?php echo $post['_id']->{'$id'};?>&collection=<?php echo $post['collection'];?>" data-rel="dialog">
                                    Modify
                                </a>
                                <div class="clear">
                                </div>
                            ...
                            <div class="postleftholder">
                                <a onclick="link(this);" class="postbynametext" href="index.php?page=profile&id=<?php echo $post['userId'];?>">
                            ...
                            <?php } /* ----------- ENDS IF ELSE STATEMENT ---------- */?>
                                <div class="eachpost"><?php
                                    ...
                                    if (isset($post["picUrl"]) && strlen($post["picUrl"]) > 1) {?>
                                        <img class="postphoto" src="<?php echo '../../../../SocialPostCurrent/private/model/pictures/'.$post['userId'].'/'.$post['picUrl'];?>"></img>
                                    <?php }?>
                                </div>
