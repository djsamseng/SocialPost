...
<html>
    ...
    <body>
        <div data-role="page" id="mainProfile">
            ...
            <div data-role="footer" data-position="fixed">
                <a href="?page=home" id="footerFeedLink">Feed</a>
                <a href="?page=profile" id="footerProfileLink">Profile</a>
                <a href="?page=messages" id="footerMessagesLink">Messages</a>
                <a href="?page=search" id="footerSearchLink">Search</a>
            </div>
        </div>
    </body>
</html>
